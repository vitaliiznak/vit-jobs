...
export default () => (
    <div className={styles.index}>
        <h2>Choose job boards</h2>
        <div className={styles.channelsList}>
            <div className={styles.channel}>
                <Checkbox value='netEmpregos'>
                    <h3>Net-empregos</h3>
                    <img alt='logo' src='http://www.net-empregos.com/images/logo_net3.png' />
                </Checkbox>
            </div>
            <div className={styles.channel}>
                <h3>Sapo Emprego</h3>
            ...
            <div className={styles.channel}>
                <h3>Jobtide</h3>
                <Checkbox value='bep'>
                    <img alt='logo' src={'https://d13sauvqul3gw9.cloudfront.net/4cae19777831e0a6dcda0a42f9298ac841967ebb.png'} />
                </Checkbox>
            ...
            <div className={styles.channel}>
                <h3>CareerJet</h3>
                <Checkbox value='bep'>
                    <img alt='logo' src={'https://ssl-static.careerjet.net/images/logo_ws_home_pt.png'} />
                </Checkbox>
            ...
            <div className={styles.channel}>
                <h3>Emprego XL</h3>
                <Checkbox value='bep'>
                    <img alt='logo' src={'https://scontent.flis9-1.fna.fbcdn.net/v/t1.0-9/293846_432663350129555_686007929_n.jpg?_nc_cat=106&_nc_ht=scontent.flis9-1.fna&oh=02e488c8018c58ea7f1ba9ce39ee54c4&oe=5D5CC026'} />
                </Checkbox>
            </div>
            <div className={styles.channel}>
                <h3>IT Jobs</h3>
            ...
            <div className={styles.channel}>
                <h3>Emprego Saúde</h3>
                <Checkbox value='bep'>
                    <img alt='logo' src={'http://www.empregosaude.pt/wp-content/themes/jobright/images/logo.jpg'} />
                </Checkbox>
            </div>
            <div className={styles.channel}>
                <h3>Turijobs</h3>
